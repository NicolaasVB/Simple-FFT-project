...
public class NorthEastTile extends MapTile {

	public NorthEastTile(int startHeight, int endHeight, Map parent) {
		super(startHeight, endHeight, parent);
	}

	public NorthEastTile(MapTile tile) {
		super(tile);
	}
	...
	public void draw(Graphics g) {
		...
		Polygon rightSide = new Polygon(new int[] { x, x, x + horizontal / 2,
				...
				y - drawEndHeight + vertical / 2, y + vertical / 2 }, 4);
	...
	public MapTile clone() {
		return new NorthEastTile(startHeight, endHeight, parent);
	}
